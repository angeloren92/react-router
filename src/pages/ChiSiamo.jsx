          ...
          <div className="col g-4">
            <div className="card h-100">
              <figure className="card-body row">
                <h2 className='text-center h1'>安Anazon: Tutto ciò che desideri, con il sorriso</h2>
                <img src={Logo} alt="Logo Anazon" className='img-fluid col-3' />
                <p className='col-8 my-auto'>
                  ...
                  Siamo qui per semplificarti la vita. Navigazione facile, assistenza clienti sempre presente e la certezza di fare un ottimo affare in totale sicurezza. Scopri il piacere di fare acquisti senza pensieri su [Nome Tuo Shop].
                </p>
              </figure>
            </div>
          </div>
